...
<div id="ac">
<center>post to expiries? </center><hr>
...
<input type="hidden" name="cash" placeholder="Cash" style="width: 268px; height:30px;  margin-bottom: 15px;"  /><br>
<?php
}
?><button class="btn btn-success btn-block btn-large" style="width:267px;"><i class="icon icon-save icon-large" accesskey="s"></i> yes</button>
</center>
</div>
</form>
</body>
