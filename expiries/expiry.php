...
<input type="" name="batch"  placeholder="batch" autocomplete="off" style="width: 68px; height:30px; padding-top:6px; padding-bottom: 4px; margin-right: 4px; font-size:15px;">
...
$id = $_GET['invoice'];
include '../connect.php';
$result = $db->prepare("SELECT product_code,gen_name,product,product_name,amount, o_price,expiries.qty AS qty FROM expiries RIGHT OUTER JOIN products ON products.product_id=expiries.product WHERE invoice= :userid AND amount!= ''");
