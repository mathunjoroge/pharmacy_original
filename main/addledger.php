...
<center><h5>cash Payment</h5></center>
...
<span></span><input type="hidden" style="width:265px; height:30px;" name="type" value="cash"  /><br>
<span></span><input type="hidden" style="width:265px; height:30px;" name="confnumber"  value="cash" ><br>
