...
<input type="text"  align="center" style="padding:18px;width:48%;float:none;height:35px;" id="filter" placeholder="Search category...">&nbsp;<a rel="facebox" href="addcategory.php"><Button type="submit" class="btn btn-info" style="width:150px; height:35px;" /><i class="icon-plus-sign icon-large"></i>add category</button></a></span></br></div>
