...
<input type="hidden" name="amount" value="<?php echo $_GET['bal']; ?>" />
...
<center>
    <input type="number"  value="<?php echo $_GET['bal']; ?>" style="width: 268px; height:30px;  margin-bottom: 15px;" readonly /><br>  
