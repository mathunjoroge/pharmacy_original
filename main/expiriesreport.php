...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$result = $db->prepare("SELECT *  FROM expiriestt WHERE date BETWEEN :a AND :b ORDER by transaction_id DESC ");
	...
	<thead>
		<tr>
			...
			<?php
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$results = $db->prepare("SELECT sum(amount) FROM expiriestt WHERE date BETWEEN :a AND :b");
...
<button  style="float:left;" class="btn btn-success btn-large"><a href="expirieslist.php?d1=0&d2=0"> expiries list</button></a>
