...
<link rel="shortcut icon" href="ico/logo.PNG"></head>
<body>
...
<a href="../stocktake/stocktake.php?id=cash&invoice=<?php echo $finalcode ?>"><font ><i class="icon-shopping-cart icon-2x"></i></font><br>stock take</a> 
