...
<center><h5>Mpesa Payment</h5></center>
...
<span></span><input type="hidden" style="width:265px; height:30px;" name="type" value="Mpesa"  /><br>
<span>confirm No: </span><input type="text" style="width:265px; height:30px;" name="confnumber"  required/><br>
