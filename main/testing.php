...
<strong>From : <input type="text" style="width: 150px; padding:14px;" name="d1" class="tcal" value="" autocomplete="off" required /> To: <input type="text" style="width: 150px; padding:14px;" name="d2" class="tcal" value="" autocomplete="off" required  /></span>
