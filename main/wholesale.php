...
<input type="text"  align="center" style="padding:18px;width:48%;float:none;height:35px;" id="filter" placeholder="">&nbsp;<a rel="facebox" href="editws.php"><Button type="submit" class="btn btn-info" style="width:150px; height:35px;" /><i class="icon-plus-sign icon-large"></i>add discount</button></a></span></br></div>
