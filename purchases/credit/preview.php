...
<?php include('navfixed.php');?>
	...
	<div class="span10">
	<a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>"><button class="btn btn-default"><i class="icon-arrow-left"></i> New sale</button></a>
...
<div style="margin: 0 auto; padding: 20px; width: 900px; font-weight: normal;">
	...
	Lumumba Subcounty Hospital: Pharmacy	
	</center>
	<div>
	<?php
	...
	<table cellpadding="3" cellspacing="0" style="font-family: arial; font-size: 12px;text-align:left;width : 100%;">
		...
		<tr><p><?php $Today = date('y:m:d',mktime());
			$new = date('d/m/20y', strtotime($Today));
			echo $new;?></p>
		</tr>
	</table>
