...
<div class="container">
	<a href="purchase.php?id=cash&invoice=<?php echo $finalcode ?>"><button class="btn btn-primary"><i class="icon-arrow-left"></i> record another purchase</button></a>&nbsp;&nbsp;	<a href="../main/index.php"><button class="btn btn-primary"><i class="icon-arrow-left"></i> Go to sales</button></a>
...
<?php } ?>
	...
	<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;" width="100%">
		...
		<tbody>
				...
				<?php
					$id=$_GET['invoice'];
					$result = $db->prepare("SELECT product_code,gen_name,product,product_name,amount, o_price,pending.qty AS qty, pending.amount, discount FROM pending RIGHT OUTER JOIN products ON products.product_id=pending.product WHERE invoice= :userid");
