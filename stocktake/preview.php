...
<?php include('navfixed.php');?>
	...
	<div class="">
	<a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>"><button class="btn btn-primary"><i class="icon-arrow-left"></i> record another purchase</button></a>&nbsp;&nbsp;	<a href="http://localhost/elians/main/index.php"><button class="btn btn-primary"><i class="icon-arrow-left"></i> Go to sales</button></a>
