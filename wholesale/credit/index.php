...
<a href="main/others.php">Logout</a>
<?php
}
...
?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li><a href="purchaseslist.php"><i class="icon-group icon-2x"></i> view purchases</a>                                  </li>
			<li><a href="../salesreport"><i class="icon-bar-chart icon-2x"></i> Sales Report</a>                </li>
			<br><br><br><br><br><br>		
			<li>
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#0099cc;"><center>Lumumba Subcounty Hospital: Pharmacy</center></font>
<div id="mainmain">
...
<a href="purchases.php"><font color="blue"><i class="icon-shopping-cart icon-2x"></i></font><br> Record Purchase</a> 
