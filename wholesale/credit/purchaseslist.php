	...
	<div class="span2">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li><a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>"><i class="icon-inbox icon-large"></i> Cash <div class="pull-right"><i class="icon-circle-arrow-right icon-large"></i></div></a></li>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<td><a rel="" href="view_purchases_list.php?iv=<?php echo $row['invoice_number']; ?>"> <button class="btn btn-primary btn-mini"><i class="icon-search"></i> View purchase details</button></a> 
