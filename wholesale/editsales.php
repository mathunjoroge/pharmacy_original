<?php
	include('../connect.php');
	$id=$_GET['id'];
	$result = $db->prepare("SELECT * FROM sales_order RIGHT OUTER JOIN products ON products.product_id=sales_order.product WHERE transaction_id= :userid");
...
<span>quantity </span><input type="text" style="width:265px; height:30px;"  name="qty" value="<?php echo $row['quantity']; ?>" /><br>
